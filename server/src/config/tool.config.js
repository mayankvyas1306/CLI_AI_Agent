...
export const availableTools = [
    ...
    },
    {
        id:"code_execution",
        name:"Code Execution",
        description:"Generate and execute Python code to perform calculation, solve problems, or provide accurate information",
    ...
    },
    {
        id:"url_context",
        name:"URL Context",
        description:"Provide specific URLs that you want the model to analyze directly from the prompt Support up to 20 URLs par request.",
